...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Create Colors `}</title>

        <meta
          name="description"
          content="Welcome to Create Colors, your HueGenius platform that empowers creativity through a spectrum of vibrant hues. Simplifying color generation for designers, artists, and color enthusiasts."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1661956602116-aa6865609028?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxkZXNpZ258ZW58MHx8fHwxNjg5OTQ1NzIwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Create Colors, your HueGenius platform that empowers creativity through a spectrum of vibrant hues. Simplifying color generation for designers, artists, and color enthusiasts.`}
            </Text>
            <Box
